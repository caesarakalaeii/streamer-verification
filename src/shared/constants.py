...
# OAuth Configuration
DISCORD_OAUTH_SCOPES = ["identify", "role_connections.write"]  # Linked Roles requires role_connections.write
...
ERROR_TOKEN_ALREADY_USED = "This verification link has already been used. Please run /verify again."
ERROR_DISCORD_MISMATCH = "This verification link belongs to a different Discord user."
ERROR_DISCORD_OAUTH_NOT_COMPLETED = "Discord authentication not completed. Please start over."
ERROR_TWITCH_ALREADY_LINKED = "This Twitch account is already linked to another Discord user."
...
ERROR_NO_PERMISSION_NICKNAME = "Bot lacks permission to manage nicknames. Please contact an administrator."
ERROR_NO_PERMISSION_ROLE = "Bot lacks permission to manage roles. Please contact an administrator."

# Success Messages
SUCCESS_VERIFICATION_COMPLETE = "✅ Successfully verified as {twitch_username}! You can close this page and return to Discord."
SUCCESS_DISCORD_VERIFIED = "✅ Discord identity verified. Now please authenticate with Twitch."
